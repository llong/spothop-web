...
define(['./workbox-5db6c9d5'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/^https:\/\/maps\.googleapis\.com\/maps\/api\/mapsjs\/gen_204.*/i, new workbox.NetworkOnly(), 'GET');
