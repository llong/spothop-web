...
function TermsComponent() {
    ...
    return (
        <Container maxWidth="md" sx={{ py: 8 }}>
            ...
            <Paper sx={{ p: 4, borderRadius: 1, backgroundColor: 'background.paper' }}>
                ...
                <Box sx={{
                    ...
                    <Typography variant="subtitle2" fontWeight={800} sx={{ fontSize: '0.75rem !important', mt: 2 }}>
                    ...
                    <Typography variant="subtitle2" fontWeight={800} sx={{ fontSize: '0.75rem !important' }}>
